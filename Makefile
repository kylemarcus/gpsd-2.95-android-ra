...
#am__append_1 = $(DBUS_CFLAGS) $(DBUS_GLIB_CFLAGS) -DDBUS_API_SUBJECT_TO_CHANGE=1
#am__append_2 = $(BLUEZ_CFLAGS)
...
check_PROGRAMS = test_float$(EXEEXT) test_trig$(EXEEXT) \
	...
	$(am__EXEEXT_4)
#am__append_3 = test_gpsmm
#am__append_4 = test_qgpsmm

# Warning: This overrides autoconf's normal link-line generation process
#am__append_5 = libgpsmm.cpp
#am__append_6 = stamp-python setup.py
#am__append_7 = stamp-python stamp-python.tmp
#am__append_8 = stamp-qt
#am__append_9 = stamp-qt
#am__append_10 = stamp-gps-manpages stamp-gps-manpages.tmp
subdir = .
...
libgpsd_la_OBJECTS = $(am_libgpsd_la_OBJECTS) \
	$(nodist_libgpsd_la_OBJECTS)
##am__EXEEXT_1 = gpsdecode$(EXEEXT)
#am__EXEEXT_2 = cgps$(EXEEXT) gpsmon$(EXEEXT)
#am__EXEEXT_3 = test_gpsmm$(EXEEXT)
#am__EXEEXT_4 = test_qgpsmm$(EXEEXT)
...
#test_gpsmm_DEPENDENCIES = $(am__DEPENDENCIES_1) \
...
ACLOCAL = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/missing --run tar
AR = arm-linux-androideabi-ar
AUTOCONF = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/missing --run autoconf
AUTOHEADER = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/missing --run autoheader
AUTOMAKE = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/missing --run automake-1.11
AWK = mawk
BLUEZ_CFLAGS = 
BLUEZ_LIBS = 
...
LD = /home/kmarcus2/android/lib/arm-linux-androideabi/bin/ld
LDFLAGS = -static
LIBC = -lc
LIBM = -lm
LIBNSL = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/missing --run makeinfo
MANTARGET = 
MKDIR_P = /bin/mkdir -p
NCURSES_LIBS = 
NM = /home/kmarcus2/android/lib/bin/arm-linux-androideabi-nm -B
NMEDIT = 
...
PYTHON_CFLAGS = -DHAVE_PYTHON -I/usr/include/python2.7
PYTHON_DISTUTILS_LIBDIR = build/lib.linux-i686-2.7
PYTHON_DISTUTILS_SCRIPTDIR = build/scripts-2.7
...
XMLPROC = 
XMLPROCFLAGS = 
abs_builddir = /home/kmarcus2/Downloads/gpsd-2.95
abs_srcdir = /home/kmarcus2/Downloads/gpsd-2.95
abs_top_builddir = /home/kmarcus2/Downloads/gpsd-2.95
abs_top_srcdir = /home/kmarcus2/Downloads/gpsd-2.95
ac_ct_CC = 
ac_ct_CXX = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/kmarcus2/Downloads/gpsd-2.95/install-sh
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/gpsd
pkgpythondir = ${pythondir}/gpsd
prefix = /home/kmarcus2/Downloads/bin/gpsd-2.95
...
include ./$(DEPDIR)/driver_oncore.Plo
...
include ./$(DEPDIR)/gps_maskdump.Plo
include ./$(DEPDIR)/gpsctl.Po
include ./$(DEPDIR)/gpsd.Po
include ./$(DEPDIR)/gpsd_dbus.Po
include ./$(DEPDIR)/gpsd_json.Plo
include ./$(DEPDIR)/gpsd_maskdump.Plo
